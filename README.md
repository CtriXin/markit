...
- Annotation tools：pin、rect（drag 或 two-click）、freehand 圈画、element pick、section/card 区块选择；右侧展示 selector/label/score。
- Bug workflow：保存 bug、bug list、bug detail、status/severity/title/actual/expected 编辑、annotation relation。
